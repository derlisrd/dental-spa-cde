                ...
                <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($e->pagado)
                                <a href="{{ route('empleados.comisiones.pagar',$e->id) }}" class="btn btn-info rounded-pill">Ver recibo</a>
                                @else
                                <a href="{{ route('empleados.comisiones.pagar',$e->id) }}" class="btn btn-success btn-sm rounded-pill">Pagar</a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
